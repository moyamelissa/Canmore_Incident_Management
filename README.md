...
- 🛡️ **Admin Dashboard** - Manage incident statuses and permissions
...
│   │   ├── home_route.py       # Home page
│   │   ├── map_route.py        # Map page
│   │   ├── report_route.py     # Report page
│   │   ├── info_route.py       # Information page
│   │   ├── incident_types.py   # Incident types API
│   │   ├── incidents_api.py    # Incidents API
│   │   └── user_settings_api.py# User settings API
│   └── data/                   # Data files
│
├── static/                      # Static assets
│   ├── css/                    # Stylesheets
│   ├── js/                     # Client-side scripts
│   ├── data/                   # GeoJSON and CSV data
│   ├── img/                    # Images
│   ├── icons/                  # UI icons
│   └── audio/                  # Sound effects
│
